...
def aes128_xts(enc_mode:bool, key1:bytes, key2:bytes, data_unit_num:int, text_in:bytes):
    ...
    for j in range(len(text_in) >> 4):
        ...
        # encypt/decrypt
        pre_out = aes128_ecb_enc(key1, block_text) if enc_mode else aes128_ecb_dec(key1, block_text)
...
if __name__ == '__main__':
    ...
    # encryption
    ct = aes128_xts(True, key1, key2, tweak, plaint_text)
    ...
    # decryption
    pt = aes128_xts(False, key1, key2, tweak, bytes.fromhex(golden_cipher_text))
